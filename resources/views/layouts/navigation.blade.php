<nav x-data="{ open: false }" class="bg-white dark:bg-neutral-900 border-b border-gray-100 dark:border-neutral-700">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex items-center sm:pr-12">
                ...
                <!-- Navigation Links -->
                @if (Auth::user() && Auth::user()->role === 'TEACHER_ROLE')
                    @include('layouts.menu-profesor')
                @endif

                @if (Auth::user() && Auth::user()->role === 'USER_ROLE')
